...
PAGE_URL_MAPPING = {
    ...
    'COE Marks Approval': 'examination.coe_marks_approval',
    'COE Approval': 'examination.coe_approval_form',
    ...
    'Degree Exam Master': 'examination.degree_exam_master',
    'Exam Config Master': 'examination.exam_config_master',
    'Degree Exam Wise Weightage': 'examination.degree_exam_wise_weightage',
    'External Examiner Detail': 'examination.external_examiner_detail',
    'External Examiner Communication': 'examination.external_examiner_communication',
    'Update Weightage Post Marks Entry': 'examination.update_weightage_post_marks_entry',
    'Student Marks Entry(@COE)': 'examination.student_marks_entry_coe',
    'Student Marks Entry(UG and MBA)': 'examination.student_marks_entry_ug',
    'Student Marks Entry(ExternalUser)': 'examination.student_marks_entry_external_user',
    'Teacher Assigned Courses for Student Marks Entry(PG/PHD)': 'examination.teacher_assigned_courses_pgphd',
    'Student Marks Entry(PG/PHD) By Teacher': 'examination.student_marks_entry_pg_phd',
    'Student Marks Entry(Re-Evaluation)': 'examination.student_marks_entry_re_evaluation',
    'Student Marks Entry(Revised)': 'examination.student_marks_entry_revised',
    'Student Marks Entry(Igrade)': 'examination.student_marks_entry_igrade',
    'Student Marks Entry(Revised PG/PHD)': 'examination.student_marks_entry_revised_pg_phd',
    'Student Marks Entry PG/PhD Summer': 'examination.student_marks_entry_pg_phd_summer',
    'Student Grading (NCC/NSS)': 'examination.student_marks_entry_ncc_nss',
    'HOD Marks Approval': 'examination.hod_marks_approval',
    'Student Marks Entry (Supplementary)': 'examination.student_marks_entry_supplementary',
    ...
    'HOD Approval': 'academics.hod_approval_advisory',
    ...
    'College Dean Approval': 'academics.college_dean_approval_advisory',
    'Dean PGS approval (advisory committee)': 'academics.dean_pgs_approval_advisory',
    ...
    'Prepare Course Plan': 'academics.prepare_course_plan',

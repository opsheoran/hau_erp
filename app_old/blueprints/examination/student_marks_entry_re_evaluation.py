...
@examination_bp.route('/student_marks_entry_re_evaluation', methods=['GET', 'POST'])
@permission_required('Student Marks Entry(Re-Evaluation)')
def student_marks_entry_re_evaluation():
    if request.method == 'POST':
        ...
        return redirect(url_for('examination.student_marks_entry_re_evaluation',
    ...
    return render_template('examination/student_marks_entry_re_evaluation.html', 

...
function DropDownAlert(obj) {
    ...
    var z = obid.substr(45, 1);
    var ctl1 = x + y + z;
    var p = obid.substr(37, 2) + "_ddlGr";
    var q = obid.substr(45, 1);
    var ctl2 = x + p + q;
    if (obj.value == 'A' || obid == ctl2) {
...
function CheckLength(txt, max, event) {
...
function IsDate(dtStr) {
    ...
    var strDay = dtStr.substring(0, pos1 + 1)    // var strDay = dtStr.substring(0, pos1)       //
    var strMonth = dtStr.substring(pos1 + 1, pos2 + 1)  //var strMonth = dtStr.substring(pos1 + 1, pos2)  //
